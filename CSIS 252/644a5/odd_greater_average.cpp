...
/*
 * Function: 	calculate
 * Description: Will return the integer of the number of odd integers which are greater
 * 		than the average.
 * Input: 	numbers (array of int) - used to find values
 * 		count (int) - length of array
 * Output: 	count_odd_greater_avg (int) - the count of the integers which 
