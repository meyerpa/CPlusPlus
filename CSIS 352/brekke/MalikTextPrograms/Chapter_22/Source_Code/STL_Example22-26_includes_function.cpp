...
int main()
{
	...
	if (includes(setB, setB + 10, setA, setA + 5))	//Line 14
		cout << "Line 15: setA is a subset of setB"
			 << endl;								//Line 15
	else											//Line 16
		cout << "Line 17: setA is not a subset of setB"
			 << endl;								//Line 17

	if (includes(setB, setB + 10, setC, setC + 5))	//Line 18
		cout << "Line 19: setC is a subset of setB"
			 << endl;								//Line 19
	else											//Line 20
		cout << "Line 21: setC is not a subset of setB"
			 << endl;								//Line 21
