...
template<class elemType> class Array {
  public:
   ...
   // method - getMaxLength
    ...
    // preconditions - index the same type as the array was declared
    // postconditions - <none>
    // method input - index
...
elemType& Array<elemType>::operator[](elemType index) {
...
template<class elemType> 
const elemType& Array<elemType>::operator[](elemType index) const {
  // throw an exception if outside the array boundaries
  if (length>=max_length)
//    cerr << "max length is too small\n";
    throw out_of_range("out_of_range: cannot insert into a full list");
